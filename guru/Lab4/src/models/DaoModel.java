	...
	public void createTable() {
		...
		// Open a connection
		 ...
		 //Create table in database
			 String sql = "CREATE TABLE gurutejachowdary " + 
		...
		//close db connection
		 conn.connect().close();  
			 ...
			 System.out.println("\nTable 'gurutejachowdary' already exits in the database");
		}
		     }
			  ...
			  for (int i = 0; i <robjs.length; ++i) {
			   ...
			   // (id, income, pep) into your database table
				 ...
				 sql = "INSERT INTO srini_duli_tab" +
						 ...
						 sql = "INSERT INTO gurutejachowdary" +
						 "(id, income, pep)" +
						 "VALUES('"+id+"', "+income+", '"+pep+"')";
			...
			public ResultSet retrieveRecords() {
				 ...
				 System.out.println("Connected to the database.\n"+
						 			"\nSELECT * from gurutejachowdary order by pep desc"+
						 			"\nRetrieving Records from the table...");
				 String sql = "SELECT * from gurutejachowdary order by pep desc";
				// execute the query
